...
import com.liderman.mundolidermanapp.presentation.presenter.PaymentPresenter
import com.liderman.mundolidermanapp.presentation.ui.base.LiderManBaseActivity
import kotlinx.android.synthetic.main.activity_mis_boletas.*
import java.io.Serializable
import java.util.*
import java.util.Calendar.YEAR
import javax.inject.Inject

class MyTicketsActivity : LiderManBaseActivity(), PaymentPresenter.View {
    ...
    override fun getView(): Int = R.layout.activity_mis_boletas

    override fun onCreate() {
        super.onCreate()
        component.inject(this)
        setSupportActionBar("Mis Boletas", R.color.white)
        ...
        btn_search?.setOnClickListener {
            if (selectedMonthVal.isNotEmpty() && selectedYearVal.isNotEmpty()) {
                paymentPresenter.getPayments("${selectedYearVal}${selectedMonthVal}")
            } else {
    ...
    override fun successPayment(paymentEntity: PaymentEntity) {
        startActivityE(
            MyTicketsDetailActivity::class.java,
            paymentEntity as Serializable,
