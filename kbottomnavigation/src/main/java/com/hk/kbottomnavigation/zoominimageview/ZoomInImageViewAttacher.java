...
import com.hk.kbottomnavigation.zoominimageview.animation.AnimCompat;
import com.hk.kbottomnavigation.zoominimageview.animation.SpringInterpolator;
import com.hk.kbottomnavigation.zoominimageview.gestures.OnScaleAndMoveGestureListener;
import com.hk.kbottomnavigation.zoominimageview.gestures.ScaleAndMoveDetector;
import com.hk.kbottomnavigation.zoominimageview.window.WindowManagerUtil;
...
public class ZoomInImageViewAttacher implements View.OnTouchListener {
     ...
     * drag imageview
     */
    private AppCompatImageView mZoomIV;
    /**
     * drag image Bitmap
     */
    ...
    public void attachImageView(AppCompatImageView imageView) {
        ...
        mImageView = new WeakReference<AppCompatImageView>(imageView);
    ...
    public ZoomInImageViewAttacher(AppCompatImageView imageView) {
    ...
    private synchronized void createZoomImage(Bitmap bitmap, int mOffsetToLeft, int mOffsetToTop) {
        ...
        mZoomIV = (AppCompatImageView) mWindowLayout.findViewById(R.id.iv_zoominpic);
        ...
        mZoomIV.setScaleType(AppCompatImageView.ScaleType.MATRIX);
    ...
    private class AnimatedZoomRunnable implements Runnable {
        ...
        @Override
        public void run() {
            AppCompatImageView imageView = mZoomIV;
            if (imageView == null) {
                return;
            }
